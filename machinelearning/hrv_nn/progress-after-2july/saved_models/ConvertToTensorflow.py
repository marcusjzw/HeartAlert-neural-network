...
# Taken from: https://heartbeat.fritz.ai/deploying-pytorch-and-keras-models-to-android-with-tensorflow-mobile-a16a1fb83f2
...
keras_model.load_weights("vt_classification_model_complete75PERCENT.h5")


output_dir = os.path.join(os.getcwd(),"checkpoint")

keras_to_tensorflow(keras_model,output_dir=output_dir,model_name="vt_classification_model_complete75PERCENT.pb")
